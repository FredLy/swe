...
insert into Artikel values(0,'Winterjacke EsIstKalt',54,99.99,3,9,1,2012-10-29,NULL);
insert into Artikel values(1,'BlueJeans Classic','31/31',49.99,NULL,10,1,2012-10-29,NULL);
insert into Artikel values(2,'Schicker Anzug','52',499.99,NULL,2,1,2012-10-29,NULL);
insert into Artikel values(3,'Lederguertel Active','M',29.95,NULL,1,1,2012-10-29,NULL);
insert into Artikel values(4,'Abendkleid Frischluft','40',99.95,NULL,11,0,2012-10-29,NULL);

insert into Kunde values(0,'fred.ly@googlemail.com','Ly','Fred','Auerbacher Straße','5A','86514','Angelbach',2012-10-29,NULL);
insert into Kunde values(1,'pascal.vetter21@googlemail.com','Vetter','Pascal','Breitenweg','22','94832','Bietigheim',2012-10-29,NULL);
insert into Kunde values(2,'eberhardt.yannick@gmail.com','Eberhardt','Yannick','Crossweg','1','47512','Chemnitz',2012-10-29,NULL);
insert into Kunde values(3,'kristian.sudar@gmail.com','Sudar','Kristian','Drachtengasse','23','21564','Dallau',2012-10-29,NULL);
insert into Kunde values(4,'menges.marc@gmail.com','Menges','Marc','Erlenweg','87B','47862','Eberbach',2012-10-29,NULL);

insert into Bestellung values(0,'Bestellung_K0_0,0',2012-01-23,NULL,2012-10-29,NULL);
insert into Bestellung values(1,'Bestellung_K1_0,0',2012-01-23,NULL,2012-10-29,NULL);
insert into Bestellung values(2,'Bestellung_K2_0,0',2012-01-23,NULL,2012-10-29,NULL);
insert into Bestellung values(3,'Bestellung_K3_0,0',2012-01-23,NULL,2012-10-29,NULL);
insert into Bestellung values(4,'Bestellung_K3_1,0',2012-01-23,NULL,2012-10-29,NULL);

insert into Posten values(0,1,0,0,0,2012-10-29,NULL);
insert into Posten values(1,2,0,1,1,2012-10-29,NULL);
insert into Posten values(2,1,1,3,0,2012-10-29,NULL);
insert into Posten values(3,5,2,4,0,2012-10-29,NULL);
insert into Posten values(4,1,2,1,1,2012-10-29,NULL);
insert into Posten values(5,1,3,2,0,2012-10-29,NULL);
insert into Posten values(6,2,4,4,0,2012-10-29,NULL);
