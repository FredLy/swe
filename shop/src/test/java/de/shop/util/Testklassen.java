...
public enum Testklassen {
	...
	private List<Class<? extends AbstractTest>> 
	classes = Arrays.asList(KundeTest.class, ArtikelTest.class, BestellungTest.class, 
			BestellungServiceTest.class, ArtikelServiceTest.class, KundeServiceTest.class); 
