...
public class SucheBezeichnungActivity extends Activity {
	private static final String LOG_TAG = SucheBezeichnungActivity.class.getSimpleName();
	...
	private void suchen(String bezeichnung) {
		final Artikel artikel = artikelServiceBinder.sucheArtikelByBezeichnung(bezeichnung);
